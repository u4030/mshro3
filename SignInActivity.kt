...
class SignInActivity : AppCompatActivity(), TextWatcher{
    ...
    override fun onStart() {
        ...
        if (mAuth.currentUser?.uid != null){
            val intentMainActivity = Intent(this@SignInActivity, Users::class.java)
...
//                }
                ...
                btn_create_account.isClickable=false
                btn_create_account.isEnabled=false
                btn_create_account.visibility=View.INVISIBLE

                editText_email_sign_in.setText("")
                editText_password_sign_in.setText("")
